...
static const Rule rules[] = {
	...
	RULE(.class = "Gimp", .tags = 1 << 4)
	RULE(.class = "Firefox", .tags = 1 << 7)
  RULE(.class = "latexocr", .isfloating = 1)
...
static const char *web3[] = { "firefox", "-new-window", "https://chatgpt.com/?model=gpt-4o", NULL };
...
static const char *screensaver[] = {"xdg-screensaver", "activate", NULL};
...
static const Key keys[] = {
  ...
  {MODKEY,                        XK_F12,        spawn,                  {.v = screensaver } },
